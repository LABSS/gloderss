...
baseOutput <- "/data/workspace/gloders/gloderss/output/figures/Qs/Q1"
...
#
base <- "/data/workspace/gloders/gloderss/output/data/Qs"
baseOutput <- "/data/workspace/gloders/gloderss/output/figures/Qs/Q2"
...
#
base <- "/data/workspace/gloders/gloderss/output/data/Qs"
baseOutput <- "/data/workspace/gloders/gloderss/output/figures/Qs/Q3"
...
#
base <- "/data/workspace/gloders/gloderss/output/data/Qs"
baseOutput <- "/data/workspace/gloders/gloderss/output/figures/Qs/Q4"
...
#
base <- "/data/workspace/gloders/gloderss/output/data/Qs"
baseOutput <- "/data/workspace/gloders/gloderss/output/figures/Qs/Q5"
...
ggplot(data, aes(x=factor(scenario), y=as.numeric(as.character(paidExt))*100,
                 fill=factor(scenario))) +
  xlab('Configuration') + ylab('Proportion of paid pizzo') + ylim(65,85) +
  geom_boxplot(fill=fills) +
  theme(axis.title.x = element_text(colour = 'black', size = 36, face = 'bold'),
        axis.title.y = element_text(colour = 'black', size = 36, face = 'bold'),
        axis.text.x = element_text(colour = 'black', size = 24, face = 'bold'),
...
ggplot(data, aes(x=factor(scenario), y=as.numeric(as.character(propPun))*100,
                 fill=factor(scenario))) +
  xlab('Configuration') + ylab('Proportion of punishments') + ylim(0,45) +
  geom_boxplot(fill=fills) +
  theme(axis.title.x = element_text(colour = 'black', size = 36, face = 'bold'),
        axis.title.y = element_text(colour = 'black', size = 36, face = 'bold'),
        axis.text.x = element_text(colour = 'black', size = 24, face = 'bold'),
