...
public class DenounceExtortionAction extends ActionAbstract {
   ...
   * @return none
   */
  public DenounceExtortionAction( int extortionId, int entrepreneurId, int stateId, int mafiosoId ) {
    super( Actions.DENOUNCE_EXTORTION.ordinal(),
        Actions.DENOUNCE_EXTORTION.name() );
