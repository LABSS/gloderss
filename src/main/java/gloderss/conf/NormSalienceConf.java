...
public class NormSalienceConf {
	...
	@XmlAttribute(name = Constants.TAG_NORMATIVE_NORM_INITIAL_INVOCATION_COMPLIANCE)
	...
	@XmlAttribute(name = Constants.TAG_NORMATIVE_NORM_INITIAL_INVOCATION_VIOLATION)
