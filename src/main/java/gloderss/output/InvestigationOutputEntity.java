...
public class InvestigationOutputEntity extends AbstractEntity {
  
  public enum Field {
    TIME("time", DataType.INTEGER),
    CONDUCTED_GENERAL_INVESTIGATION("conductedGeneralInv", DataType.INTEGER),
    REQUESTED_SPECIFIC_INVESTIGATION("requestedSpecificInv", DataType.INTEGER),
    CONDUCTED_SPECIFIC_INVESTIGATION("conductedSpecificInv", DataType.INTEGER);
  ...
  public InvestigationOutputEntity( int id, String separator ) {
    super( id );
    this.separator = separator;
    this.entity = new Object[Field.values().length];
    
    this.entity[Field.TIME.ordinal()] = 0.0;
    this.entity[Field.CONDUCTED_GENERAL_INVESTIGATION.ordinal()] = 0;
    this.entity[Field.REQUESTED_SPECIFIC_INVESTIGATION.ordinal()] = 0;
    this.entity[Field.CONDUCTED_SPECIFIC_INVESTIGATION.ordinal()] = 0;
  }
